...
sequenceDiagram
    ...
    participant API as 🌐 Vantari bridge

    Note over serverStore: State:<br/>props: ApiVantariServerProps | null<br/>loading, error<br/>role: ServerRole | null (MODEL | ROUTER)<br/>fetchPromise (deduplication)
    ...
    API-->>PropsSvc: ApiVantariServerProps
