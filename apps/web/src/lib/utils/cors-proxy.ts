/**
 * CORS Proxy utility for routing requests through Vantari bridge's CORS proxy.
 */
...
/**
 * Build a proxied URL that routes through Vantari bridge's CORS proxy.
...
/**
 * Wrap original headers for proxying through the CORS proxy. This avoids issues with duplicated Vantari-specific and target headers when using the CORS proxy.
