 ...
 *
 * @example
 * normalizeModelName('models/vantari-3.1-8b') // Returns: 'vantari-3.1-8b' (multiple slashes -> filename)
 * normalizeModelName('C:\\Models\\gpt-4') // Returns: 'gpt-4' (multiple slashes -> filename)
 * normalizeModelName('meta-vantari/Vantari-3.1-8B') // Returns: 'meta-vantari/Vantari-3.1-8B' (Hugging Face format)
