...
import { vantariChatFetch } from '$lib/services/vantari.service';
...
export class ChatService {
	...
	/**
	 * Sends a chat completion request to the Vantari bridge.
	...
	static async sendMessage(
		...
		try {
			...
			// VANTARI: the OpenAI-compatible SSE body is synthesized by the
	 ...
	 *
	 * WORKAROUND: In single model mode, Vantari bridge returns a default/incorrect model name
