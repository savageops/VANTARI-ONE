...
export class PropsService {
	 ...
	 */
	static async fetch(autoload = false): Promise<ApiVantariServerProps> {
		...
		return apiFetchWithParams<ApiVantariServerProps>('./props', params, { authOnly: true });
	}
	 ...
	 */
	static async fetchForModel(modelId: string, autoload = false): Promise<ApiVantariServerProps> {
