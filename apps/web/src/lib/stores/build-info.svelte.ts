/**
 * buildInfoStore - Vantari build information
 *
 * Reads the build version from `build.json` — embedded at Vantari build time
 * with the Vantari build number (VANTARI_BUILD_NUMBER). Shown in the UI when
