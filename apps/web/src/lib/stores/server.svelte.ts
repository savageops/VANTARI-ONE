...
class ServerStore {
	...
	props = $state<ApiVantariServerProps | null>(null);
	loading = $state(false);
	...
	get defaultParams(): ApiVantariServerProps['default_generation_settings']['params'] | null {
	...
	private detectRole(props: ApiVantariServerProps): void {
