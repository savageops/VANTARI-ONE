			...
			<div class="mt-4 text-left" in:fly={{ delay: 400, duration: 300, y: 10 }}>
				<details class="text-sm">
					...
					<div class="mt-2 space-y-3 text-xs text-muted-foreground">
						<div class="space-y-2">
							<p class="mb-4 font-medium">Start the Vantari owner:</p>

							<div class="rounded bg-muted/50 px-2 py-1 font-mono text-xs">
								<p>vantari serve --port 18833</p>
							</div>

							<p>
								Run it from your workspace root; the web app reaches it through the
								browser bridge at <code>127.0.0.1:18833</code>.
							</p>
						</div>
