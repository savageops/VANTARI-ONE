...
<script lang="ts">
	...
	function mockModelsStore() {
		modelsStore.favoriteModelIds = new Set(['qwen2.5-7b', 'vantari3.2-3b']);
	...
	const loadedModels: ModelItem[] = [
		{ flatIndex: 0, option: mockModel('vantari3.1-8b', 'Vantari-3.1-8B-Instruct', 'meta') },
	...
	const favoriteModels: ModelItem[] = [
		...
		{ flatIndex: 3, option: mockModel('vantari3.2-3b', 'Vantari-3.2-3B-Instruct', 'meta') }
	];
	...
	const availableModels: ModelItem[] = [
		...
		{ flatIndex: 7, option: mockModel('codevantari-7b', 'CodeVantari-7B', 'codevantari', ['coding']) },
