 ...
 */
export function mockServerProps(props: Partial<ApiVantariServerProps>): void {
	...
	(serverStore as unknown as { props: ApiVantariServerProps }).props = {
		modalities: {
		...
		...props
	} as ApiVantariServerProps;

	// Set router mode role so activeModelId can be set
	(serverStore as unknown as { props: ApiVantariServerProps }).props.role = 'ROUTER';
