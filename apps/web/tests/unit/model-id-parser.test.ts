...
describe('parseModelId', () => {
	...
	it('handles real-world examples correctly', () => {
		expect(parseModelId('meta-vantari/Vantari-3.1-8B')).toStrictEqual({
			activatedParams: null,
			modelName: 'Vantari-3.1',
			orgName: 'meta-vantari',
			params: '8B',
			quantization: null,
			raw: 'meta-vantari/Vantari-3.1-8B',
			tags: []
		});
	...
	it('handles real-world examples with quantization in segments', () => {
		expect(parseModelId('meta-vantari/Vantari-4-Scout-17B-16E-Instruct-Q4_K_M')).toStrictEqual({
			activatedParams: null,
			modelName: 'Vantari-4-Scout',
			orgName: 'meta-vantari',
			params: '17B',
			quantization: 'Q4_K_M',
			raw: 'meta-vantari/Vantari-4-Scout-17B-16E-Instruct-Q4_K_M',
			tags: ['16E', 'Instruct']
		});
