...
- [`todo/changelog/036g-ticket-agent-pool-and-repair.md`](todo/changelog/036g-ticket-agent-pool-and-repair.md) — historical ticket/pool closeout receipt. The 2026-08-12 audit supersedes its production-complete conclusion: installed parity and remaining multi-process proof remain open. Moves 21–29 now close presentation persistence, scheduler leadership, ticket admission, queue-only assignment, durable agent messaging, model-selected eligibility, capacity truth, and owner-generation reconciliation in source.
