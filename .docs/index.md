...
- [`todo/changelog/036g-ticket-agent-pool-and-repair.md`](todo/changelog/036g-ticket-agent-pool-and-repair.md) — historical ticket/pool closeout receipt. The 2026-08-12 audit supersedes its production-complete conclusion: owner-crash recovery, installed parity, and remaining multi-process writer proof remain open. Moves 21–26 now close presentation persistence, scheduler leadership, ticket admission, queue-only assignment, and durable agent messaging in source.
