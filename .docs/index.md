...
- [`research/2026-08-13-fixed-pool-capacity-truth.md`](research/2026-08-13-fixed-pool-capacity-truth.md) — Move 28 nine-reference harvest, canonical active/idle/queued/admission arithmetic, idle-boundary pool refresh, and contention proof.
- [`research/2026-08-13-owner-generation-reconciliation.md`](research/2026-08-13-owner-generation-reconciliation.md) — Move 29 eight-source harvest, terminal-first same-session resume contract, absent-session requeue boundary, live-owner heartbeat, and mailbox-cursor preservation.
...
- [`research/2026-08-14-prompt-mode-orchestrator-owner.md`](research/2026-08-14-prompt-mode-orchestrator-owner.md) — PromptMode becomes the root orchestration owner; legacy config remains read-compatible but inert.
...
- [`research/2026-08-14-question-panel-input-lifecycle.md`](research/2026-08-14-question-panel-input-lifecycle.md) — stale question-panel cleanup at terminal/error boundaries, active-input cancellation routing, all-mode regression proof, and deferred installed promotion.
- [`research/2026-08-14-question-panel-event-loop-recovery.md`](research/2026-08-14-question-panel-event-loop-recovery.md) — shared idle/streaming key failure boundary, source proof, and the preserved installed-owner boundary.
- [`research/2026-08-14-question-modal-frame.md`](research/2026-08-14-question-modal-frame.md) — full-frame question modal, layout-collision removal, multi-select review behavior, and source-only proof boundary.
- [`research/2026-08-14-question-modal-batch-boundary.md`](research/2026-08-14-question-modal-batch-boundary.md) — bounded input envelope, terminal-cell-safe question display, maximum-batch viewport proof, and the preserved installed boundary.
- [`research/2026-08-14-failure-receipts-move71.md`](research/2026-08-14-failure-receipts-move71.md) — one bounded deterministic failure receipt projected through terminal sessions and ticket recovery.
- [`research/2026-08-14-yagni-repair-replay-retirement.md`](research/2026-08-14-yagni-repair-replay-retirement.md) — YAGNI retirement of the optional repair/replay control plane; canonical session, event, ticket, review, and write-intent owners retained.
- [`research/2026-08-14-roadmap-24-full-checklist.md`](research/2026-08-14-roadmap-24-full-checklist.md) — current requirement ledger for the attached orchestrator scope, Roadmap 24 rows, child acceptance checks, and promotion frontier.
- [`research/2026-08-14-roadmap-24-provider-probe.md`](research/2026-08-14-roadmap-24-provider-probe.md) — source-side real-provider response, exact event spine, process cleanup, and the runtime-root boundary it exposed.
- [`research/2026-08-14-roadmap-24-installed-input-response.json`](research/2026-08-14-roadmap-24-installed-input-response.json) — installed `ask_user`/`InputBroker`/`input/respond` proof with event and graceful-exit evidence.
- [`research/2026-08-14-roadmap-24-installed-write-effect.json`](research/2026-08-14-roadmap-24-installed-write-effect.json) — installed explicit `build` read/write/effect proof with committed write intent, transcript evidence, event lifecycle, and graceful-exit evidence.
- [`research/2026-08-14-roadmap-24-installed-frontier-proof.json`](research/2026-08-14-roadmap-24-installed-frontier-proof.json) — compact current installed evidence for the retained consumer paths and explicit typed boundaries.
- [`research/2026-08-14-roadmap-24-completion-audit.md`](research/2026-08-14-roadmap-24-completion-audit.md) — numbered Roadmap 24 disposition, YAGNI owner census, current gate, and boundary audit.
- [`research/2026-08-14-roadmap-24-release-manifest.json`](research/2026-08-14-roadmap-24-release-manifest.json) — generated source/installed hashes, current test totals, capability-owner inventory, proof scripts, docs state, process census, and promotion blockers.
- [`research/2026-08-14-performance-telemetry-move84.md`](research/2026-08-14-performance-telemetry-move84.md) — Move 84 owner audit, false zero-valued stats proof, and measured-owner reopen gate.
 - [`research/2026-08-14-allocator-quota-move85.md`](research/2026-08-14-allocator-quota-move85.md) — Move 85 deletion of the unused allocator quota shell and source proof.
- [`research/2026-08-14-write-intents-real-tools.md`](research/2026-08-14-write-intents-real-tools.md) — Move 62 write-tool reserve/commit wiring, append-only abandoned-intent closure, six-source pressure, and source-only proof boundary.
- [`research/2026-08-14-windows-install-owner-boundary-move88.md`](research/2026-08-14-windows-install-owner-boundary-move88.md) — Move 88 authenticated installer shutdown, stale-lock refusal, process-tree proof, and preserved installed-promotion boundary.
- [`research/2026-08-14-ticket-quota-scheduler-policy.md`](research/2026-08-14-ticket-quota-scheduler-policy.md) — Move 63 ownership audit, queue-only assignment boundary, sole capacity key, private scheduler constants, and source-only proof.
- [`research/2026-08-14-ticket-only-work-lifecycle.md`](research/2026-08-14-ticket-only-work-lifecycle.md) — Move 64 owner census, ticket-only lifecycle consolidation, reference pressure, deletion boundary, and source proof.
- [`research/2026-08-14-native-tool-schema-prompt-boundary.md`](research/2026-08-14-native-tool-schema-prompt-boundary.md) — Move 65 native schema/API boundary, hot-loaded behavior ownership, demand-loaded diagnostics, and source proof.
...
- [`research/2026-08-14-context-shard-projection-move70.md`](research/2026-08-14-context-shard-projection-move70.md) — Move 70 receipt-addressed parent projection, bounded child suffix, shard lifecycle separation, and source-only proof.
...
- [`todo/changelog/021c-codex-subscription-auth.md`](todo/changelog/021c-codex-subscription-auth.md) — shipped Codex OAuth PKCE login, durable provider upsert, logout, refresh hooks, and secret-free CLI status.
- [`todo/changelog/021d-codex-subscription-auth.md`](todo/changelog/021d-codex-subscription-auth.md) — explicit OAuth Codex Responses transport, account/originator headers, fake transport coverage, and installed local fixture proof.
- [`todo/changelog/021e-codex-subscription-auth.md`](todo/changelog/021e-codex-subscription-auth.md) — installed/workspace auth ownership, sanitized operator examples, bootstrap semantics, and secret-free documentation search proof.
- [`todo/changelog/021f-codex-subscription-auth.md`](todo/changelog/021f-codex-subscription-auth.md) — full auth-chain regression, health/status fixture proof, invariant checks, and closeout evidence.
- [`todo/changelog/021-codex-subscription-auth.md`](todo/changelog/021-codex-subscription-auth.md) — archived parent contract and chain manifest; no pending auth continuation.
...
- [`todo/changelog/035g-provider-cost-compat-model.md`](todo/changelog/035g-provider-cost-compat-model.md) — installed priced/unknown provider turns, event-ledger readback, multiline `/status`, and TUI row-owner regression proof.
 - [`todo/changelog/076-windows-install-owner-boundary-move88.md`](todo/changelog/076-windows-install-owner-boundary-move88.md) — Move 88 fail-closed Windows installer lock handling and graceful owner drain proof.
- [`todo/changelog/077-performance-telemetry-move84.md`](todo/changelog/077-performance-telemetry-move84.md) — Move 84 deletion of the unconnected stats surface and source rejection proof.
- [`todo/changelog/078-allocator-quota-yagni-move85.md`](todo/changelog/078-allocator-quota-yagni-move85.md) — Move 85 deletion of the unused allocator quota shell and 2,180-test source proof.
- [`todo/changelog/079-plugin-runtime-yagni-moves86-87.md`](todo/changelog/079-plugin-runtime-yagni-moves86-87.md) — Moves 86–87 deletion of speculative plugin discovery and supervision; contract-only owner boundary retained.
- [`todo/changelog/080-yagni-moves81-83.md`](todo/changelog/080-yagni-moves81-83.md) — Moves 81–83 consolidation of checkpoint branches, session/event read models, and existing execution budgets.
- [`todo/changelog/081-owner-projection-clean-shutdown.md`](todo/changelog/081-owner-projection-clean-shutdown.md) — exact owner-projection removal after clean shutdown with stale/replaced projection preservation.
- [`todo/changelog/082-installed-current-release-boundary.md`](todo/changelog/082-installed-current-release-boundary.md) — current ReleaseFast install, installed consumer probes, equal hash, and final owner census.
- [`todo/changelog/083-current-source-install-reconciliation.md`](todo/changelog/083-current-source-install-reconciliation.md) — fresh current-source ReleaseFast install, `2,182/2,182` graph, equal hash, and remaining Move 89 boundary.
- [`todo/changelog/084-release-build-seed-reproducibility.md`](todo/changelog/084-release-build-seed-reproducibility.md) — pinned Zig ReleaseFast seed, repeated artifact equality, promotable current manifest, and installed proof refresh.
- [`todo/changelog/085-installed-input-response-move89.md`](todo/changelog/085-installed-input-response-move89.md) — installed provider-driven question response through the canonical input owners.
- [`todo/changelog/086-installed-write-effect-move89.md`](todo/changelog/086-installed-write-effect-move89.md) — installed explicit `build` read/write/effect proof through the canonical review, write-intent, transcript, event, and terminal owners.
...
- [`todo/changelog/052-question-panel-input-lifecycle.md`](todo/changelog/052-question-panel-input-lifecycle.md) — stale panel teardown, active-input cancellation routing, and source-only crash-boundary proof.
- [`todo/changelog/061-question-panel-event-loop-recovery.md`](todo/changelog/061-question-panel-event-loop-recovery.md) — shared question key/response error containment for idle and streaming TUI loops.
...
- [`todo/changelog/070-provider-capability-dispatch.md`](todo/changelog/070-provider-capability-dispatch.md) — adapter-backed provider capability probe at dispatch and fail-closed unresolved wire selection.
...
- [`todo/changelog/055-ticket-only-work-lifecycle.md`](todo/changelog/055-ticket-only-work-lifecycle.md) — Move 64 ticket-only lifecycle, duplicate writer deletion, and source proof.
- [`todo/changelog/056-native-tool-schema-prompt-boundary.md`](todo/changelog/056-native-tool-schema-prompt-boundary.md) — Move 65 native tool schema prompt boundary and catalog deletion proof.
...
- [`todo/changelog/062-context-shard-projection-move70.md`](todo/changelog/062-context-shard-projection-move70.md) — Move 70 bounded context shards, parent range preservation, and source proof.
