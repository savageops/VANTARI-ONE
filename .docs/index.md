...
- [`research/2026-08-14-repair-apply-move76.md`](research/2026-08-14-repair-apply-move76.md) — Move 76 exact approved-patch application through the existing reviewed writer, write-intent evidence, retry identity, and rejected patcher/queue designs.
- [`research/2026-08-14-repair-rerun-move77.md`](research/2026-08-14-repair-rerun-move77.md) — Move 77 exact-input/config treatment child, pre-dispatch identity gate, normal provider-lane replay, idempotent relationship receipts, and cold-start boundary.
...
- [`todo/changelog/068-repair-candidate-baseline.md`](todo/changelog/068-repair-candidate-baseline.md) — proposal-only repair candidate, source-baseline conflict detection, and source-only proof boundary.
- [`todo/changelog/069-repair-approval-boundary.md`](todo/changelog/069-repair-approval-boundary.md) — operator-only approval bound to the exact candidate, patch hash, and source baseline; source-only proof boundary.
...
- [`todo/changelog/071-repair-apply-move76.md`](todo/changelog/071-repair-apply-move76.md) — operator-only approved repair application through `replace_in_file`, applied receipt, write-intent proof, and retry idempotence.
- [`todo/changelog/072-repair-rerun-move77.md`](todo/changelog/072-repair-rerun-move77.md) — exact repair replay through a fresh linked child and the canonical provider lane.
