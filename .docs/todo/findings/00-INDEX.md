...
open for owner-crash reconciliation, durable agent messaging, installed proof,
and remaining multi-process writer authority. Move 23 closes scheduler
leadership; move 24 closes ticket claim/lease/child admission split-brain.
...
| 11 | P0 | [Persistent agent worker and scheduler arbitration](11-persistent-agent-worker-and-scheduler-arbitration.md) | agents, scheduler, host | moves 21–24 source-complete/closed; pending moves 25–30 |
