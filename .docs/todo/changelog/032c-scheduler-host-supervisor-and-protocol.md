---
id: 032c-scheduler-host-supervisor-and-protocol
...
phase: c
status: done
patch_scope: "Supervisor thread and shutdown semantics"
blast_radius: high
...
acceptance: "Supervisor thread and shutdown semantics is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 032b-scheduler-host-supervisor-and-protocol is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/032d-scheduler-host-supervisor-and-protocol.md."
dependencies: "032b-scheduler-host-supervisor-and-protocol"
next_todo: /todo/pending/032d-scheduler-host-supervisor-and-protocol.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/032c-scheduler-host-supervisor-and-protocol.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 032c-scheduler-host-supervisor-and-protocol Supervisor thread and shutdown semantics

## Execute Now
Implement Supervisor thread and shutdown semantics inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 032b-scheduler-host-supervisor-and-protocol is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/host, clients/cli, shared/protocol scheduler surfaces - implement only the Supervisor thread and shutdown semantics slice.
...
- 032c-scheduler-host-supervisor-and-protocol has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/032d-scheduler-host-supervisor-and-protocol.md after this file is archived.
...
## Next todo
/todo/pending/032d-scheduler-host-supervisor-and-protocol.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/032c-scheduler-host-supervisor-and-protocol.md and continue immediately.
