---
id: 029k-scheduler-due-engine-and-leases
...
phase: k
status: done
patch_scope: "Due-engine adversarial tests"
blast_radius: high
...
acceptance: "Due-engine adversarial tests is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 029j-scheduler-due-engine-and-leases is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/029l-scheduler-due-engine-and-leases.md."
dependencies: "029j-scheduler-due-engine-and-leases"
next_todo: /todo/pending/029l-scheduler-due-engine-and-leases.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/029k-scheduler-due-engine-and-leases.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 029k-scheduler-due-engine-and-leases Due-engine adversarial tests

## Execute Now
Implement Due-engine adversarial tests inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 029j-scheduler-due-engine-and-leases is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler engine modules - implement only the Due-engine adversarial tests slice.
...
- 029k-scheduler-due-engine-and-leases has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/029l-scheduler-due-engine-and-leases.md after this file is archived.
...
## Next todo
/todo/pending/029l-scheduler-due-engine-and-leases.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/029k-scheduler-due-engine-and-leases.md and continue immediately.
