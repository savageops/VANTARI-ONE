---
id: 031g-scheduler-tool-and-catalog
...
phase: g
status: done
patch_scope: "Pause and resume action parser and executor"
blast_radius: high
...
acceptance: "Pause and resume action parser and executor is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 031f-scheduler-tool-and-catalog is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/031h-scheduler-tool-and-catalog.md."
dependencies: "031f-scheduler-tool-and-catalog"
next_todo: /todo/pending/031h-scheduler-tool-and-catalog.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/031g-scheduler-tool-and-catalog.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 031g-scheduler-tool-and-catalog Pause and resume action parser and executor

## Execute Now
Implement Pause and resume action parser and executor inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 031f-scheduler-tool-and-catalog is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/tools builtin scheduler tool and catalog wiring - implement only the Pause and resume action parser and executor slice.
...
- 031g-scheduler-tool-and-catalog has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/031h-scheduler-tool-and-catalog.md after this file is archived.
...
## Next todo
/todo/pending/031h-scheduler-tool-and-catalog.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/031g-scheduler-tool-and-catalog.md and continue immediately.
