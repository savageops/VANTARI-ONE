---
id: 031d-scheduler-tool-and-catalog
...
phase: d
status: done
patch_scope: "Get and list action parser and executor"
blast_radius: high
...
acceptance: "Get and list action parser and executor is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 031c-scheduler-tool-and-catalog is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/031e-scheduler-tool-and-catalog.md."
dependencies: "031c-scheduler-tool-and-catalog"
next_todo: /todo/pending/031e-scheduler-tool-and-catalog.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/031d-scheduler-tool-and-catalog.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 031d-scheduler-tool-and-catalog Get and list action parser and executor

## Execute Now
Implement Get and list action parser and executor inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 031c-scheduler-tool-and-catalog is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/tools builtin scheduler tool and catalog wiring - implement only the Get and list action parser and executor slice.
...
- 031d-scheduler-tool-and-catalog has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/031e-scheduler-tool-and-catalog.md after this file is archived.
...
## Next todo
/todo/pending/031e-scheduler-tool-and-catalog.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/031d-scheduler-tool-and-catalog.md and continue immediately.
