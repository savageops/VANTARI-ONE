---
id: 029g-scheduler-due-engine-and-leases
...
phase: g
status: done
patch_scope: "Recurring next-due update on completion"
blast_radius: high
...
acceptance: "Recurring next-due update on completion is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 029f-scheduler-due-engine-and-leases is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/029h-scheduler-due-engine-and-leases.md."
dependencies: "029f-scheduler-due-engine-and-leases"
next_todo: /todo/pending/029h-scheduler-due-engine-and-leases.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/029g-scheduler-due-engine-and-leases.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 029g-scheduler-due-engine-and-leases Recurring next-due update on completion

## Execute Now
Implement Recurring next-due update on completion inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 029f-scheduler-due-engine-and-leases is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler engine modules - implement only the Recurring next-due update on completion slice.
...
- 029g-scheduler-due-engine-and-leases has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/029h-scheduler-due-engine-and-leases.md after this file is archived.
...
## Next todo
/todo/pending/029h-scheduler-due-engine-and-leases.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/029g-scheduler-due-engine-and-leases.md and continue immediately.
