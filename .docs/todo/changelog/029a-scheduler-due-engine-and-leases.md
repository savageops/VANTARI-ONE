---
id: 029a-scheduler-due-engine-and-leases
...
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/029b-scheduler-due-engine-and-leases.md."
dependencies: ""
next_todo: /todo/pending/029b-scheduler-due-engine-and-leases.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/029a-scheduler-due-engine-and-leases.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 029a-scheduler-due-engine-and-leases Due-engine contract lock
...
- 029a-scheduler-due-engine-and-leases has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/029b-scheduler-due-engine-and-leases.md after this file is archived.
...
## Next todo
/todo/pending/029b-scheduler-due-engine-and-leases.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/029a-scheduler-due-engine-and-leases.md and continue immediately.
