---
id: 030k-scheduler-target-adapters
...
phase: k
status: done
patch_scope: "Target adapter integration tests"
blast_radius: high
...
acceptance: "Target adapter integration tests is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 030j-scheduler-target-adapters is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/030l-scheduler-target-adapters.md."
dependencies: "030j-scheduler-target-adapters"
next_todo: /todo/pending/030l-scheduler-target-adapters.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/030k-scheduler-target-adapters.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 030k-scheduler-target-adapters Target adapter integration tests

## Execute Now
Implement Target adapter integration tests inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 030j-scheduler-target-adapters is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler target adapters and command/session integration - implement only the Target adapter integration tests slice.
...
- 030k-scheduler-target-adapters has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/030l-scheduler-target-adapters.md after this file is archived.
...
## Next todo
/todo/pending/030l-scheduler-target-adapters.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/030k-scheduler-target-adapters.md and continue immediately.
