...
phase: h
status: done
patch_scope: "Delete and tombstone projection semantics"
blast_radius: high
...
acceptance: "Delete and tombstone projection semantics is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 027g-scheduler-core-ledger is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/027i-scheduler-core-ledger.md."
dependencies: "027g-scheduler-core-ledger"
next_todo: /todo/pending/027i-scheduler-core-ledger.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/027h-scheduler-core-ledger.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 027h-scheduler-core-ledger Delete and tombstone projection semantics

## Execute Now
Implement Delete and tombstone projection semantics inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 027g-scheduler-core-ledger is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler ledger modules - implement only the Delete and tombstone projection semantics slice.
...
- 027h-scheduler-core-ledger has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/027i-scheduler-core-ledger.md after this file is archived.
...
## Next todo
/todo/pending/027i-scheduler-core-ledger.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/027h-scheduler-core-ledger.md and continue immediately.
