---
id: 032a-scheduler-host-supervisor-and-protocol
parent: 032-scheduler-host-supervisor-and-protocol
type: execution-unit
...
acceptance: "The scheduler phase interpretation is frozen with source anchors, invariants, and downstream entry-state contracts recorded."
exit_criterion: "ix inspect AGENTS.md --range 1:220 && ix inspect apps/backend/README.md --range 1:120 exits 0 with expected scheduler evidence."
validation: "ix inspect AGENTS.md --range 1:220 && ix inspect apps/backend/README.md --range 1:120"
expected_exit_code: 0
expected_output_pattern: "VAR1"
...
entry_state: "Parent todo exists in /todo/pending and no implementation unit for this chain has been archived."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/032b-scheduler-host-supervisor-and-protocol.md."
dependencies: ""
next_todo: /todo/pending/032b-scheduler-host-supervisor-and-protocol.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/032a-scheduler-host-supervisor-and-protocol.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 032a-scheduler-host-supervisor-and-protocol Host lifecycle contract lock

## Execute Now
Freeze the interpretation, source anchors, invariants, and downstream entry-state contract for this scheduler chain without editing implementation code.
...
- Current patch surface: apps/backend/src/host/{stdio_rpc.zig,http_bridge.zig,bridge_access.zig}; apps/backend/src/shared/protocol/types.zig; apps/backend/src/clients/cli.zig; scheduler supervisor lifecycle tests
...
## Entry State
- Parent todo exists in /todo/pending and no implementation unit for this chain has been archived.
...
|------|---------|-------------------|------------------------|-----------|
| 1 | ix inspect AGENTS.md --range 1:220 && ix inspect apps/backend/README.md --range 1:120 | 0 | VAR1 | yes |
| 2 | ix search 'lit:scheduler-host-supervisor-and-protocol' .docs/todo/pending --max-hits 20 | 0 | ix.result.v1 | yes |
...
- 032a-scheduler-host-supervisor-and-protocol has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/032b-scheduler-host-supervisor-and-protocol.md after this file is archived.
...
## Next todo
/todo/pending/032b-scheduler-host-supervisor-and-protocol.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/032a-scheduler-host-supervisor-and-protocol.md and continue immediately.
