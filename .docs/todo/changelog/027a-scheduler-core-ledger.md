---
id: 027a-scheduler-core-ledger
parent: 027-scheduler-core-ledger
type: execution-unit
...
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/027b-scheduler-core-ledger.md."
dependencies: ""
next_todo: /todo/pending/027b-scheduler-core-ledger.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/027a-scheduler-core-ledger.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 027a-scheduler-core-ledger Ledger schema contract lock
...
- Current patch surface: apps/backend/src/core/scheduler/{types.zig,ledger.zig,projection.zig,attempts.zig,index.zig}; core namespace export if required; .var/schedules/ storage contract tests
...
| 2 | ix search 'lit:scheduler-core-ledger' .docs/todo/pending --max-hits 20 | 0 | ix.result.v1 | yes |
...
- 027a-scheduler-core-ledger has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/027b-scheduler-core-ledger.md after this file is archived.
...
## Next todo
/todo/pending/027b-scheduler-core-ledger.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/027a-scheduler-core-ledger.md and continue immediately.
