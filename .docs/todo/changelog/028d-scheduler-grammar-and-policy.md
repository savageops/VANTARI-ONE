---
id: 028d-scheduler-grammar-and-policy
...
phase: d
status: done
patch_scope: "Five-field cron parser"
blast_radius: high
...
acceptance: "Five-field cron parser is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 028c-scheduler-grammar-and-policy is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/028e-scheduler-grammar-and-policy.md."
dependencies: "028c-scheduler-grammar-and-policy"
next_todo: /todo/pending/028e-scheduler-grammar-and-policy.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/028d-scheduler-grammar-and-policy.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 028d-scheduler-grammar-and-policy Five-field cron parser

## Execute Now
Implement Five-field cron parser inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 028c-scheduler-grammar-and-policy is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler parser and policy modules - implement only the Five-field cron parser slice.
...
- 028d-scheduler-grammar-and-policy has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/028e-scheduler-grammar-and-policy.md after this file is archived.
...
## Next todo
/todo/pending/028e-scheduler-grammar-and-policy.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/028d-scheduler-grammar-and-policy.md and continue immediately.
