---
id: 028k-scheduler-grammar-and-policy
...
phase: k
status: done
patch_scope: "Temporal parser and policy tests"
blast_radius: high
...
acceptance: "Temporal parser and policy tests is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 028j-scheduler-grammar-and-policy is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/028l-scheduler-grammar-and-policy.md."
dependencies: "028j-scheduler-grammar-and-policy"
next_todo: /todo/pending/028l-scheduler-grammar-and-policy.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/028k-scheduler-grammar-and-policy.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 028k-scheduler-grammar-and-policy Temporal parser and policy tests

## Execute Now
Implement Temporal parser and policy tests inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 028j-scheduler-grammar-and-policy is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler parser and policy modules - implement only the Temporal parser and policy tests slice.
...
- 028k-scheduler-grammar-and-policy has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/028l-scheduler-grammar-and-policy.md after this file is archived.
...
## Next todo
/todo/pending/028l-scheduler-grammar-and-policy.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/028k-scheduler-grammar-and-policy.md and continue immediately.
