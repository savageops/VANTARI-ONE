---
id: 030g-scheduler-target-adapters
...
phase: g
status: done
patch_scope: "shell command allowlist policy skeleton"
blast_radius: high
...
acceptance: "shell command allowlist policy skeleton is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 030f-scheduler-target-adapters is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/030h-scheduler-target-adapters.md."
dependencies: "030f-scheduler-target-adapters"
next_todo: /todo/pending/030h-scheduler-target-adapters.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/030g-scheduler-target-adapters.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 030g-scheduler-target-adapters shell command allowlist policy skeleton

## Execute Now
Implement shell command allowlist policy skeleton inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 030f-scheduler-target-adapters is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler target adapters and command/session integration - implement only the shell command allowlist policy skeleton slice.
...
- 030g-scheduler-target-adapters has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/030h-scheduler-target-adapters.md after this file is archived.
...
## Next todo
/todo/pending/030h-scheduler-target-adapters.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/030g-scheduler-target-adapters.md and continue immediately.
