---
id: 030e-scheduler-target-adapters
...
phase: e
status: done
patch_scope: "shell_exec payload schema"
blast_radius: high
...
acceptance: "shell_exec payload schema is implemented through the canonical scheduler/runtime surface and validated by a 30-case value-test matrix."
...
entry_state: "Dependency 030d-scheduler-target-adapters is archived in /todo/changelog with non-PLACEHOLDER evidence."
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/030f-scheduler-target-adapters.md."
dependencies: "030d-scheduler-target-adapters"
next_todo: /todo/pending/030f-scheduler-target-adapters.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/030e-scheduler-target-adapters.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 030e-scheduler-target-adapters shell_exec payload schema

## Execute Now
Implement shell_exec payload schema inside the canonical scheduler/runtime boundary and prove the slice with adversarial tests.
...
## Entry State
- Dependency 030d-scheduler-target-adapters is archived in /todo/changelog with non-PLACEHOLDER evidence.

## Patch Surface

**Modifies:**
- apps/backend/src/core/scheduler target adapters and command/session integration - implement only the shell_exec payload schema slice.
...
- 030e-scheduler-target-adapters has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/030f-scheduler-target-adapters.md after this file is archived.
...
## Next todo
/todo/pending/030f-scheduler-target-adapters.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/030e-scheduler-target-adapters.md and continue immediately.
