---
id: 028a-scheduler-grammar-and-policy
parent: 028-scheduler-grammar-and-policy
type: execution-unit
...
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/028b-scheduler-grammar-and-policy.md."
dependencies: ""
next_todo: /todo/pending/028b-scheduler-grammar-and-policy.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/028a-scheduler-grammar-and-policy.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 028a-scheduler-grammar-and-policy Temporal policy contract lock
...
- Current patch surface: apps/backend/src/core/scheduler/{grammar.zig,time.zig,policy.zig,next_due.zig}; parser and recurrence tests
...
| 2 | ix search 'lit:scheduler-grammar-and-policy' .docs/todo/pending --max-hits 20 | 0 | ix.result.v1 | yes |
...
- 028a-scheduler-grammar-and-policy has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/028b-scheduler-grammar-and-policy.md after this file is archived.
...
## Next todo
/todo/pending/028b-scheduler-grammar-and-policy.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/028a-scheduler-grammar-and-policy.md and continue immediately.
