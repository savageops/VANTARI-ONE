---
id: 031a-scheduler-tool-and-catalog
parent: 031-scheduler-tool-and-catalog
type: execution-unit
...
rollback_surface: "Revert only files named in this unit's Patch Surface; if validation fails, leave this unit pending or blocked and do not advance to /todo/pending/031b-scheduler-tool-and-catalog.md."
dependencies: ""
next_todo: /todo/pending/031b-scheduler-tool-and-catalog.md
continuation: "On completion: record evidence (replace PLACEHOLDER), set status done, move this file to /todo/changelog/031a-scheduler-tool-and-catalog.md, continue immediately to next_todo. Do not pause. Do not batch."
blocked_reason: ""
unblock_action: ""
resumption_point: ""
---
# 031a-scheduler-tool-and-catalog Tool contract and schema lock
...
- Current patch surface: apps/backend/src/core/tools/builtin/schedule_job.zig; apps/backend/src/core/tools/{runtime.zig,registry.zig,index.zig,module.zig,review.zig}; provider schema/catalog tests
...
| 2 | ix search 'lit:scheduler-tool-and-catalog' .docs/todo/pending --max-hits 20 | 0 | ix.result.v1 | yes |
...
- 031a-scheduler-tool-and-catalog has satisfied its acceptance criterion and recorded non-PLACEHOLDER evidence.
...
- The next unit may begin from /todo/pending/031b-scheduler-tool-and-catalog.md after this file is archived.
...
## Next todo
/todo/pending/031b-scheduler-tool-and-catalog.md
...
- [ ] Status set to done.
- [ ] Move this file to /todo/changelog/031a-scheduler-tool-and-catalog.md and continue immediately.
