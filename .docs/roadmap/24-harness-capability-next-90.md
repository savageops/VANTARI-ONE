...
| 38 | consolidate | reopened/pending | Historical install proof passed for an earlier artifact. Current ReleaseFast is `3062D10908D9678793298BDD3982EF515A3D953C9085E1EE5C681856725EE00E`; installed remains `5DBF0B5F0D82954D80BD9E21202BCC46EE534CE6FD70A483464F95F878AD33DC`. Replace and rerun installed smokes only after operator-owned PIDs 12028/14452 exit naturally. |
...
| 22 | Wire `run-session` to that owner and remove any dead launcher-shaped surface. | `clients/cli.zig`; a submitted session is observably claimed. |
