...
- **Proof:** **closed for the tracked TUI.** Source lanes pass 59/59 and 1,934/1,934. Installed catch-up after sequence 1 returned exactly sequences 2–4 and exited with zero processes. Browser refresh remains open because this checkout ships no tracked browser consumer.
